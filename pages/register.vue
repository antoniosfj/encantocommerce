...
<template>
  <div class='xl:-mt-[80px] flex items-center justify-center md:h-screen px-6 py-8'>
    <the-wrapper show>
      ...
      w-full lg:max-w-xl p-10 rounded-lg bg-white dark:bg-zinc-800 shadow'>
        <h2 class='text-2xl font-bold text-left'>
          Crie sua conta
        </h2>
        <p class='mt-2 mb-12 text-left text-zinc-500 dark:text-zinc-400'>
        ...
        <form>
            ...
            <template #step1>
              ...
              <div class='mb-5'>
                ...
                <div class='grid gap-3 mb-5 md:grid-cols-3'>
                  <div class='bg-zinc-50 dark:bg-zinc-700 text-sm w-full flex justify-between items-center p-0 border border-zinc-300 dark:border-zinc-600 rounded relative'>
                    <label
          ...
          <div class='flex justify-end flex-wrap md:flex-nowrap'>
            <span
              class='md:w-full order-3 md:order-1 font-medium text-zinc-500 dark:text-zinc-400 mr-auto self-center'>
              Já é cadastrado?
              <a
                class='text-violet-500 hover:text-violet-800'
                href='#'>
                Logue aqui
              </a>
            </span>
            <div class='flex w-full order-2 my-4 md:my-0'>
              <button
                class='w-full btn-secondary mr-2 font-bold'
                @click.prevent='step--'>
                Voltar
              </button>
              <button
      ...
      <!-- <template #overlay>
        <div class='animate-pulse'>
          <div class='h-1 bg-violet-500 rounded col-span-2' />
        </div>
      </template> -->
    </the-wrapper>
  </div>
